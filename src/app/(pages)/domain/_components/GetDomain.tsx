...
const GetDomain: React.FC = () => (
    <div className='relative flex flex-col items-center justify-center py-[50px] md:py-20 xl:py-[103.61px] 3xl:py-[186.49px]'>
        ...
        <div className='relative z-10 flex flex-col items-center justify-center'>
            <span className='text-center text-[24px] md:text-[43px] 3xl:text-[64px] leading-normal md:leading-[51.6px] 3xl:leading-[76.8px] font-900 font-roboto text-home-heading  max-w-[264px] md:max-w-[539px] 3xl:max-w-[809.839px] mx-auto'>
                Get More With Your Domain
            </span>
            <span className='text-center text-[15px] xl:text-[17px] 3xl:text-[22px] leading-[24.75px] xl:leading-[28.5px] 3xl:leading-[36.3px] font-roboto-serif font-500 mt-[19px] xl:mt-[20.39px] 3xl:mt-[30.47px] max-md:mx-4 block md:hidden lg:block w-[221px] md:w-full mx-auto'>
