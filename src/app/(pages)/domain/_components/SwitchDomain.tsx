        ...
        <div className='bg-home-secondary-card py-[150px] max-md:py-[40px]'>
            <div className='flex justify-center gap-32 max-lg:gap-10 max-xl:gap-4 mx-32 max-2xl:mx-24 max-xl:mx-10 max-lg:mx-30 max-md:m-6 max-lg:flex-col'>
                ...
                <div className='w-[900px] max-2xl:w-[650px] 2xl:w-[951px]  max-lg:w-full'>
                    <span className='text-[#000659] text-[48px] max-2xl:text-[43px] max-md:text-2xl max-xl:text-3xl 2xl:text-[64px] tracking-tight font-900 text-home-heading'>Switch Domains, Effortlessly!</span>
