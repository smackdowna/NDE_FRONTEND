...
const DomainCard: React.FC<DomainCardProps> = ({ image, title, price, originalPrice, index, hoveredCard, setHoveredCard }) => (
  <div
    ...
    className={`relative hover:scale-105 w-full max-w-[400px] group shadow-[0px_2px_2px_0px_#00000040] h-[200px] rounded-[10px] p-[2px] transition-all duration-300 ${hoveredCard === index ? 'bg-gradient-to-r from-blue-500 to-yellow-500' : 'bg-transparent'}`}
...
const Perfectdomain: React.FC = () => {
  ...
  Build your brand with the perfect domain name
      ...
      <div className='flex justify-center'>
        <div className='grid grid-cols-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-4 md:gap-[35.63px] xl:gap-[17px] 3xl:gap-[39.91px] w-full px-[20px] md:px-[90px] lg:px-[75px] 3xl:px-[100px]'>
